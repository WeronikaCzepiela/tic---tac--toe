...
export const GameItem = ({id, type, onClick}: GameItemTypes) => {
    ...
    const icons = [
        {
            type: GameItemType.CROSS, image: <img src={XIcon} color={'#1C6ECF'} height={56} width={60}/>
        },
        {
            type: GameItemType.CIRCLE, image: <img src={OIcon} color={'#1C6ECF'} height={56} width={60}/>
        }
    ]
